...
export class RaviClient {
  ...
  readonly gbp = {
    ...
    /** Inspect Google Business Profile credential metadata without resolving secrets or calling Google */
    health: async (options?: {
      connection?: string;
    }): Promise<GbpHealthReturn> => {
      return this.transport.call({
        groupSegments: ["gbp"],
        command: "health",
        body: { ...(options ?? {}) },
