...
export class RaviClient {
  ...
  readonly permissions = {
    ...
    /** Diff an agent's configured capability profile against the live context snapshot */
    diff: async (agentId: string, options?: {
      session?: string;
    }): Promise<PermissionsDiffReturn> => {
      return this.transport.call({
        groupSegments: ["permissions"],
        command: "diff",
        body: { agentId, ...(options ?? {}) },
  ...
  readonly projects = {
    ...
    /** Pin or clear the explicit focused workflow run of a project */
    focus: async (project: string, runId?: string, options?: {
      clear?: boolean;
    }): Promise<ProjectsFocusReturn> => {
      return this.transport.call({
        groupSegments: ["projects"],
        command: "focus",
    ...
    tasks: {
      ...
      /** List tasks attached to a project through its workflow runs */
      list: async (project: string, options?: {
        status?: string;
      }): Promise<ProjectsTasksListReturn> => {
        return this.transport.call({
          groupSegments: ["projects","tasks"],
          command: "list",
          body: { project, ...(options ?? {}) },
    ...
    workflows: {
      ...
      /** Remove a workflow run link from a project */
      unlink: async (project: string, runId: string): Promise<ProjectsWorkflowsUnlinkReturn> => {
        return this.transport.call({
          groupSegments: ["projects","workflows"],
          command: "unlink",
          body: { project, runId },
